...
m 現在のブロックのみに着目した場合の探索範囲は、先ほど述べた通り約40通りです。  
r 次のブロックなどを考慮すると、指数関数的に数が増えそうな予感がしますね  
m 探索範囲が大きくなると時間がかなり掛かる事があるので、探索範囲を限定する等が要ることがあるかもしれません。    
効率的な探索方法については、よければ調べてみてください。  
...
r 人がゲームした際でも、なんとなく同じようなことを考えている気がしますね  
...
m 動作確認してみてください  
r おうちにあるラズベリーパイやジェットソンなどの積みマイコン環境でも動いたので、
  マイコンを転がしている方はそちらも使ってみてはいかがでしょうか。
